...
export const reservationAPI = {
  ...
  create_reservation: async (payload: CreateReservationPayload) => {
    return await InstanceAxis.post<Reservation>(
  ...
  update_reservation: async (id: string, payload: UpdateReservationPayload) => {
    return await InstanceAxis.patch<Reservation>(
...
export const reservationServiceAPI = {
  // GET /bookings/reservation-services/?reservation=<id>
  ...
  // GET /bookings/reservation-services/:id/
  get_one_service: async (id: string) => {
    return await InstanceAxis.get<ReservationService>(
      `/bookings/reservation-services/${id}/`
    );
  },

  // POST /bookings/reservation-services/
  create_service: async (payload: CreateReservationServicePayload) => {
    return await InstanceAxis.post<ReservationService>(
      "/bookings/reservation-services/",
      payload
    );
  },

  // PUT /bookings/reservation-services/:id/
  update_service: async (
    id: string,
    payload: UpdateReservationServicePayload
  ) => {
    return await InstanceAxis.put<ReservationService>(
      `/bookings/reservation-services/${id}/`,
      payload
    );
  },

  // DELETE /bookings/reservation-services/:id/
  ...
  get_reservation_of_client: async (id: string) => {
    return await InstanceAxis.get<Reservation[]>(
      `/bookings/user/${id}/reservations/`
    );
  },
};
...
export const reservationGraphiqueAPI = {
  get_reservation_graphique_day: async () => {
    return await InstanceAxis.get<ReservationGraphiqueDay[]>(
      `/bookings/stats/day/`
    );
  },
  get_reservation_graphique_week: async () => {
    return await InstanceAxis.get<ReservationGraphiqueWeek[]>(
      `/bookings/stats/week/`
    );
  },
  get_reservation_graphique_month: async () => {
    return await InstanceAxis.get<ReservationGraphiqueMonth[]>(
      `/bookings/stats/month/`
    );
  },
};
