...
const SettingsView = () => {
  ...
  // ⭐ NOUVEAU : contrôle de l'affichage de l'alerte
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in duration-500">
      ...
      <div className="space-y-2">
        <h2 className="text-3xl font-bold font-poppins tracking-tight">Paramètres du compte prestataire</h2>
        ...
        <Card className="rounded-2xl shadow-lg border-border/50 md:col-span-2 transition-all duration-300 hover:shadow-xl">
          <CardHeader className="space-y-3 pb-6">
            ...
            <CardDescription className="text-base leading-relaxed">
              ...
              {section === "security" && "Changez votre mot de passe afin de sécuriser votre compte."}
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={onSubmit} className="space-y-6">
              ...
              {/* FORMULAIRE : Sécurité */}
              {section === "security" && <SecurityFormPrestataire register={register as any} />}

              {/* BOUTONS */}
              <div className="flex flex-col gap-4 pt-6 border-t border-border/50">
                <div className="flex justify-end items-center gap-3">
                  {/* ⭐ BOUTON QUI OUVRE L'ALERTE */}
                  <Button
                    type="button"
                    variant="outline"
                ...
                {/* ⭐ ALERTE DE CONFIRMATION (Oui / Non) */}
                {showConfirm && (
                  <div className="flex flex-col sm:flex-row justify-end items-center gap-3 p-4 bg-muted/50 border-2 border-border rounded-xl animate-in fade-in slide-in-from-top-2 duration-300 backdrop-blur-sm">
                    ...
                    <div className="flex gap-2 w-full sm:w-auto">
                      ...
                      {/* NON : désactive et retourne sur Info perso */}
                      <Button
                        type="button"
                        variant="destructive"
