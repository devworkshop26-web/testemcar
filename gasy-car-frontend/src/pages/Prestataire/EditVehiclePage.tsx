...
const EditVehiclePage = () => {
  ...
  const methods = useForm<VehicleFormData>({
    ...
    defaultValues: {
      ...
      remise_longue_duree_pourcent: null,
      montant_caution: 0,
      ...
      province_remise_longue_duree_pourcent: null,
    },
  });
  ...
  useEffect(() => {
    ...
    reset({
      ...
      equipements:
        vehicle.equipements_details?.map((e: any) => e.id) ||
        vehicle.equipements ||
        [],
      ...
      remise_longue_duree_pourcent: vehicle.remise_longue_duree_pourcent
        ? parseFloat(vehicle.remise_longue_duree_pourcent)
        : null,
      ...
      province_remise_par_mois: vehicle.province_remise_par_mois
        ...
        : null,
      province_remise_longue_duree_pourcent: vehicle.province_remise_longue_duree_pourcent
        ? parseFloat(vehicle.province_remise_longue_duree_pourcent)
        : null,
