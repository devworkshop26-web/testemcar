...
export const cancellationPolicyAnchors = [
...
type CancellationPolicyArticlePageProps = {
  title?: string;
};

export default function CancellationPolicyArticlePage({
  title = "Remboursements",
}: CancellationPolicyArticlePageProps) {
  return (
    <HelpArticleLayout
      ...
      anchors={cancellationPolicyAnchors}
    >
