...
const refundsAnchors = [
  ...
  { id: "limitation-responsabilite", label: "Limitation générale de responsabilité" },
];
    ...
    return (
      ...
      >
        <section id="principe-general" className="space-y-4">
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Principe général</h3>
        ...
        <section id="annulation-voyageur" className="space-y-4">
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Annulation plus de 72 heures avant le début</h3>
          <p>
            Si l’annulation intervient plus de soixante-douze (72) heures avant l’heure prévue de
            début, le Voyageur reçoit le remboursement intégral du prix de location.
          </p>
          <p>Les frais mentionnés au principe général restent acquis à Mcar.</p>

          <h3 className="text-2xl font-semibold tracking-tight">Annulation entre 72 heures et 36 heures avant le début</h3>
          <p>
            Si l’annulation intervient entre soixante-douze (72) heures et trente-six (36) heures avant
            le début, le Voyageur reçoit soixante-quinze pour cent (75 %) du prix de location.
          </p>
          <p>Les frais Mcar ne sont pas remboursés.</p>

          <h3 className="text-2xl font-semibold tracking-tight">Annulation entre 36 heures et 24 heures avant le début</h3>
          <p>
            Si l’annulation intervient entre trente-six (36) heures et vingt-quatre (24) heures avant le
            début, le Voyageur reçoit cinquante pour cent (50 %) du prix de location.
          </p>
          <p>Les frais Mcar restent non remboursables.</p>

          <h3 className="text-2xl font-semibold tracking-tight">Annulation moins de 24 heures avant le début</h3>
          <p>
            Si l’annulation intervient moins de vingt-quatre (24) heures avant l’heure prévue, aucun
            remboursement du prix de location n’est garanti.
          </p>
          <p>Les frais Mcar restent acquis.</p>

          <h3 className="text-2xl font-semibold tracking-tight">Réservation effectuée moins de 24 heures avant le début</h3>
          <p>
            Si la réservation est effectuée moins de vingt-quatre (24) heures avant le début prévu, le
            Voyageur dispose d’un délai d’une (1) heure après la réservation pour annuler sans frais
          ...
          <p>
            Nonobstant les dispositions précédentes, Mcar peut, à sa seule appréciation, accorder un
            remboursement total ou partiel dans des situations exceptionnelles dûment justifiées.
          </p>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              annulation ou retard majeur de vol ou de transport empêchant objectivement la prise en
              charge du véhicule ;
            </li>
            <li>événements imprévisibles et indépendants de la volonté du Voyageur.</li>
          </ul>
          <p>Le Voyageur doit fournir tout justificatif pertinent.</p>
          <p>Mcar conserve un pouvoir d’appréciation discrétionnaire.</p>
          <p>Aucune circonstance invoquée ne garantit automatiquement un remboursement.</p>
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>la non-présentation dans les soixante (60) minutes suivant l’heure prévue ;</li>
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              <strong>Location de plus de deux (2) jours :</strong> le Voyageur est remboursé moins
              l’équivalent de deux (2) journées moyennes.
            </li>
            <li>
              <strong>Location de deux (2) jours ou moins :</strong> le Voyageur ne sera pas remboursé.
            </li>
          </ul>
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>si une modification officielle a été demandée via la plateforme ;</li>
        ...
        <section id="annulation-hote" className="space-y-4">
          ...
          <p>Toute annulation par l’Hôte doit être effectuée via la plateforme.</p>
          ...
          <p>Les frais suivants restent acquis à Mcar et ne sont pas remboursables à l’Hôte :</p>
          <ul className="list-disc space-y-2 pl-6">
            <li>frais de service Mcar ;</li>
            <li>frais de traitement de paiement ;</li>
            <li>frais Mobile Money ;</li>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Pénalité financière</h3>
          <p>
            Sauf circonstance exceptionnelle validée par Mcar, l’Hôte est soumis aux pénalités
            suivantes :
          </p>
          <ul className="list-disc space-y-2 pl-6">
            <li>
              <strong>a) Annulation plus de 48 heures avant le début :</strong> pénalité administrative
              de 40 000 Ar ou 10 % de la location (le plus élevé).
            </li>
            <li>
              <strong>b) Annulation moins de 48 heures avant le début :</strong> pénalité de 20 %.
            </li>
            <li>
              <strong>c) Annulation moins de 24 heures avant le début :</strong> pénalité renforcée,
              impact sur classement, banni un mois de la plateforme et mention visible sur le profil
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              la non-mise à disposition du véhicule dans les soixante (60) minutes suivant l’heure
              prévue ;
            </li>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Circonstances exceptionnelles pour l’Hôte</h3>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Modalités d’exécution des pénalités</h3>
        ...
        <section id="responsabilite-assurance" className="space-y-4">
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Absence de qualité d’assureur</h3>
          <p>Mcar n’est pas une compagnie d’assurance.</p>
          <p>
            Mcar ne fournit aucune couverture d’assurance automobile, responsabilité civile ou dommage.
          </p>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Assurance obligatoire de l’Hôte</h3>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Assurance optionnelle proposée via Mcar</h3>
          <p>
            Mcar peut proposer, en partenariat avec un assureur tiers, une assurance optionnelle.
          </p>
          <p>Cette assurance :</p>
          <ul className="list-disc space-y-2 pl-6">
          ...
          <p>Mcar n’assume aucune obligation d’indemnisation au titre de cette assurance.</p>
          <p>Tout litige relatif à l’assurance relève exclusivement de l’assureur concerné.</p>

          <h3 className="text-2xl font-semibold tracking-tight">Responsabilité du Voyageur</h3>
          <p>
            Le Voyageur est responsable de tout dommage, perte, dégradation ou vol survenu pendant la
            période de location.
          </p>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Protection Routière Mcar (service d’assistance optionnel)</h3>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>organisation d’hébergement temporaire en cas d’immobilisation majeure.</li>
          </ul>
          <p>Ce service constitue une assistance organisationnelle.</p>
          <p>Il ne constitue pas une assurance.</p>

          <h3 className="text-2xl font-semibold tracking-tight">Prise en charge des frais</h3>
          <p>Lorsque la Protection Routière est activée, Mcar peut, à sa discrétion :</p>
          <ul className="list-disc space-y-2 pl-6">
            <li>avancer certains frais nécessaires ;</li>
            <li>organiser une solution alternative ;</li>
            <li>accorder un hébergement temporaire.</li>
          </ul>
          <p>Les frais engagés peuvent être imputés à la partie responsable de l’incident, notamment :</p>
          <ul className="list-disc space-y-2 pl-6">
            <li>à l’Hôte en cas de panne mécanique imputable à un défaut d’entretien ;</li>
            <li>au Voyageur en cas de faute de conduite ou usage interdit.</li>
          </ul>
          <p>
            Mcar conserve un pouvoir d’appréciation quant à l’activation et à l’étendue de
            l’assistance.
          </p>
        </section>
        ...
        <section id="vols-accidents" className="space-y-4">
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Vol du véhicule</h3>
          <p>En cas de vol du véhicule pendant la période de location, le Voyageur doit :</p>
          <ul className="list-disc space-y-2 pl-6">
          ...
          <p>Le Voyageur est financièrement responsable du vol lorsque celui-ci résulte :</p>
          <ul className="list-disc space-y-2 pl-6">
          ...
          <p>
            Lorsque le vol survient sans faute démontrée du Voyageur, la prise en charge relève de
            l’assurance du véhicule.
          </p>
          <p>Mcar ne supporte aucune obligation d’indemnisation.</p>

          <h3 className="text-2xl font-semibold tracking-tight">Accident corporel</h3>
          <p>En cas d’accident entraînant des blessures corporelles :</p>
          <ul className="list-disc space-y-2 pl-6">
            <li>le conducteur est responsable selon le droit applicable ;</li>
            <li>l’assurance responsabilité civile du véhicule intervient prioritairement ;</li>
            <li>l’Hôte est responsable en tant que propriétaire selon les règles légales.</li>
          </ul>
          <p>Mcar n’assume aucune responsabilité pour les dommages corporels.</p>

          <h3 className="text-2xl font-semibold tracking-tight">Dommages matériels</h3>
          <p>
            Le Voyageur est responsable de tout dommage matériel survenu pendant la période de
            location.
          </p>
          ...
          <p>
            En l’absence de preuve de l’état initial, toute contestation sera appréciée par Mcar à sa
            discrétion.
          </p>
          <p>Mcar peut :</p>
          <ul className="list-disc space-y-2 pl-6">
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Distinction selon le mode de location</h3>
          <h4 className="text-xl font-semibold tracking-tight">Location sans chauffeur</h4>
          <p>
            Le Voyageur assume la qualité de conducteur et supporte l’ensemble des responsabilités
            liées à la conduite du véhicule.
          </p>

          <h4 className="text-xl font-semibold tracking-tight">Location avec chauffeur</h4>
          <p>Lorsque le véhicule est mis à disposition avec chauffeur :</p>
          <ul className="list-disc space-y-2 pl-6">
            <li>le chauffeur agit pour le compte de l’Hôte ;</li>
            <li>la responsabilité liée à la conduite incombe au chauffeur et à l’Hôte ;</li>
            <li>
              le Voyageur ne peut être tenu responsable des fautes de conduite sauf participation
              active ou instruction fautive.
            </li>
          </ul>

          <h3 className="text-2xl font-semibold tracking-tight">Perte totale du véhicule</h3>
          <p>
            En cas de destruction totale ou perte irrécupérable du véhicule, la responsabilité
            financière est déterminée exclusivement entre l’Hôte et le Voyageur.
          </p>
          <p>
            La valeur applicable est celle retenue par l’assurance du véhicule ou, à défaut, la valeur
            de marché locale au moment du sinistre.
          </p>
          <p>Mcar n’assume aucune obligation d’indemnisation.</p>
          <p>
            Lorsque le Voyageur a souscrit une assurance optionnelle proposée via Mcar, les conditions
            du contrat d’assurance tiers s’appliquent exclusivement.
          </p>
        </section>

        <section id="incidents-litiges" className="space-y-4">
          <h2 className="text-3xl font-bold tracking-tight">Procédure en cas d’incident et règlement des litiges</h2>

          <h3 className="text-2xl font-semibold tracking-tight">Obligation de signalement</h3>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Collecte des preuves</h3>
          <p>Les parties sont responsables de la conservation des preuves, notamment :</p>
          <ul className="list-disc space-y-2 pl-6">
            <li>photographies ;</li>
          ...
          <p>
            L’absence de preuve peut affecter la capacité de la partie concernée à obtenir réparation.
          </p>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>exécuter les retenues ou débits conformément aux autorisations contractuelles.</li>
          </ul>
          <p>Mcar :</p>
          <ul className="list-disc space-y-2 pl-6">
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Règlement des litiges</h3>
          <p>
            Les litiges relatifs aux dommages, pertes ou vols sont réglés directement entre l’Hôte et
            le Voyageur ou par leurs assureurs respectifs.
          </p>
          <p>
            En cas d’absence d’accord, les juridictions compétentes sont seules habilitées à trancher.
          </p>
        </section>

        <section id="usages-interdits" className="space-y-4">
          <h2 className="text-3xl font-bold tracking-tight">Usages interdits et déchéance des droits</h2>
          ...
          <p>Tout usage interdit entraîne la responsabilité exclusive de l’utilisateur concerné.</p>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Location sans chauffeur</h3>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Location avec chauffeur</h3>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Déchéance automatique</h3>
          <p>En cas d’usage interdit :</p>
          <ul className="list-disc space-y-2 pl-6">
            <li>toute protection routière éventuelle devient inapplicable ;</li>
            <li>
              toute assurance optionnelle peut être déclarée inopérante selon ses conditions ;
            </li>
            <li>la responsabilité financière devient illimitée à l’égard des dommages causés.</li>
          </ul>

          <h3 className="text-2xl font-semibold tracking-tight">Récupération du véhicule</h3>
          <p>En cas d’usage interdit ou de violation grave :</p>
          <ul className="list-disc space-y-2 pl-6">
            <li>L’Hôte peut, conformément à la loi, demander la restitution immédiate du véhicule ;</li>
            <li>Mcar peut suspendre le compte, bloquer l’accès et retenir les paiements.</li>
          </ul>

          <h3 className="text-2xl font-semibold tracking-tight">Sanctions contractuelles</h3>
        ...
        <section id="limitation-responsabilite" className="space-y-4">
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Nature des services</h3>
          ...
          <p>
            Toute prestation liée à l’usage du véhicule relève exclusivement de l’Hôte et du Voyageur.
          </p>

          <h3 className="text-2xl font-semibold tracking-tight">Absence de responsabilité sur l’exécution du contrat</h3>
          <p>Le contrat de location est conclu directement entre l’Hôte et le Voyageur.</p>
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Limitation financière</h3>
          <p>Dans la limite autorisée par la législation malgache applicable :</p>
          <p>
            La responsabilité totale de Mcar, toutes causes confondues, est limitée au montant total
            des frais de service perçus par Mcar au titre de la transaction concernée.
          </p>
          ...
          <p>
            Mcar ne peut être tenue responsable en cas d’événement indépendant de sa volonté,
            notamment :
          </p>
          <ul className="list-disc space-y-2 pl-6">
          ...
          <h3 className="text-2xl font-semibold tracking-tight">Indemnisation par les utilisateurs</h3>
          <p>
            Les utilisateurs s’engagent à indemniser Mcar contre toute réclamation, perte, dommage ou
            procédure résultant :
          </p>
          <ul className="list-disc space-y-2 pl-6">
